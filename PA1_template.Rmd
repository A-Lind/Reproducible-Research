...
* interval number __`r intervalWithMaximumNumberOfSteps`__
...
The mean total number of steps per day estimated with the dataset with the imputed values is __`r meanStepsPerDayImputed`__.
The median total number of steps per day estimated with the dataset with the imputed values is __`r medianStepsImputed`__

The difference in means is __`r diffMean`__. 
The difference in medians is __`r diffMedian`__. 
